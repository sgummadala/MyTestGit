package com.cvs.pos;
	...
	class TicGame extends JFrame implements  ItemListener, ActionListener 	{
...
//
			...
			for (i = 0; i <= 7; i++) {
				...
				if ((icon1 == icon2) && (icon2 == icon3) && (icon1 != null)) {
					if (icon1 == ic1) {
						...
						JOptionPane.showMessageDialog(TicGame.this, "!!!YOU won!!! click reset");
						break;
					} else if (icon1 == ic2) {
						b[(a[i][1] - 1)].setIcon(ic22);
						b[(a[i][2] - 1)].setIcon(ic22);
						b[(a[i][3] - 1)].setIcon(ic22);
						JOptionPane.showMessageDialog(TicGame.this, "won! click reset");
						break;
					}
				}
			}
		...
		public static void main(String[] args) {
			new TicGame();
			// when new Classname() is code in main method, it creates
			// instance of the class and  it's constructor gets executed
		} // eof main
	} // eof class
